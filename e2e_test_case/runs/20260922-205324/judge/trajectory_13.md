...
<trajectory>
input: 오늘 서울 날씨 어때?
- route_query {"route": "out_of_scope", "rewritten_query": "오늘 서울의 날씨 정보를 알려주세요."}
- answer_out_of_scope {}
- finalize_answer {}
...
- route_query {"route": "out_of_scope", "rewritten_query": "앞으로 삼성전자 주식의 가격이 상승할 것이라고 예상하나요?"}
- answer_out_of_scope {}
- finalize_answer {}
final output: 죄송합니다, 요청하신 내용은 제가 도와드릴 수 있는 범위 밖입니다.
</trajectory>
...
- route_query {"route": "out_of_scope", "rewritten_query": "이번 휴가 때 내가 방문할 수 있는 국내 여행지를 추천해줘."}
- answer_out_of_scope {}
- finalize_answer {}
final output: 죄송합니다, 요청하신 내용은 제가 도와드릴 수 있는 범위 밖입니다.
</trajectory>
